...
def main():
    ...
    print("=" * 80)
    print("FORESTWATCH - EXPERIMENT 2")
    print("14-CHANNEL RESNET50 WITH REGULARIZATION")
    print("=" * 80)
    ...
    print(
        f"  Warmup LR              : {WARMUP_LR}"
    )

    print(
        f"  Fine-tune LR           : {FINETUNE_LR}"
    )
    ...
    # Freeze the ResNet body
    for parameter in model.model.parameters():

        parameter.requires_grad = False

    # Train modified input layer
    ...
    print(
        "STAGE 2 - REGULARIZED FULL FINE-TUNING"
    )
